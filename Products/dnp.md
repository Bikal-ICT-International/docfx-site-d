...
|  |  | Feature | Benefit |
| :--- | :--- | :--- | :--- |
| **Inputs** | **SDI-12** | • Designed with 4x ports, each supporting 2 SDI-12 input busses<br>• Port-level addressing removes the need to address sensors in many applications<br>• Individually controlled power to each SDI-12 input | • Independent functionality<br>• Improved independence if sensor fails<br>• Faster configuration<br>• No need to address sensors |
| | **RS485** | • Designed with 2x ports each supporting 2x RS485 channels<br>• Individually controlled power to each port<br>• Ability to control (transmit commands) other systems | • Independent functionality and improved independence if sensor fails<br>• Faster configuration, no need to address sensors<br>• Compatibility with other RTUs and control systems |
